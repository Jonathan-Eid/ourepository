...
function export_rectangles($entityManager, $label_id, $coord_type, $mosaicUuid) {
    ...
    $csv_contents = "";
    $csv_contents .= "#rectangles\n";
    $csv_contents .= "#label: $label_name\n";
    $csv_contents .= "#filename: $filename\n";
    $csv_contents .= "#width: $width, height: $height\n";
    $csv_contents .= "#utm_e_upper_left: $utm_e_upper_left\n";
    $csv_contents .= "#utm_e_upper_right: $utm_e_upper_right\n";
    $csv_contents .= "#utm_e_lower_left: $utm_e_lower_left\n";
    $csv_contents .= "#utm_e_lower_right: $utm_e_lower_right\n";
    $csv_contents .= "#utm_n_upper_left: $utm_n_upper_left\n";
    $csv_contents .= "#utm_n_upper_right: $utm_n_upper_right\n";
    $csv_contents .= "#utm_n_lower_left: $utm_n_lower_left\n";
    $csv_contents .= "#utm_n_lower_right: $utm_n_lower_right\n";

    $query = "SELECT * FROM rectangles WHERE mosaic_id = $mosaic_id AND label_id = $label_id";
    $result = query_our_db($query);

    $csv_contents .= "x1,y1,x2,y2\n";
    while ($row = $result->fetch_assoc()) {
        $x1 = $row['x1'];
        $y1 = $row['y1'];
...
//        adjust_coords($y2, $x2, $height, $width);
        ...
        if ($coord_type == "PIXEL") {
            ...
            $csv_contents .= number_format($x1, 4, ".", "") . "," . number_format($y1, 4, ".", "") . "," . number_format($x2, 4, ".", "") . "," . number_format($y2, 4, ".", "") . "\n";
        }
    }
