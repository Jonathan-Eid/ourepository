    ...
    <div class="bg-blue-100 shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col w-1/2">
      ...
      <div class="mb-4 text-left">
        ...
        <input onChange={setTitle}
               ...
               id="email" type="email" placeholder="Organization Title"/>
      </div>
      <div class="pb-4"></div>
      <div class="mb-6 items-left text-left">
        ...
        <br/>
        <button onClick={submitOrg} class="p-1 rounded-md bg-gradient-to-bl bg-gray-400 hover:bg-blue-900 disabled"
                disabled={!(name && vis_set)}> Create
        </button>
