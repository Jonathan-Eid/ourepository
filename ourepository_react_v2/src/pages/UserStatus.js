...
const UserStatusPage = (props) => {
  ...
  return (<>
      <nav class="flex items-center justify-between flex-wrap bg-gray-800 p-6 fixed w-full z-10 top-0">
        ...
        <div
          className={"w-full flex-grow lg:flex lg:items-center lg:w-auto lg:block pt-6 lg:pt-0" + (navbarOpen ? " flex" : " hidden")}
          id="nav-content">
      ...
      <div class="bg-gray-600 shadow-md w-1000 h-1000 rounded px-8 pt-6 pb-8 mb-4 flex ">
        ...
        <div class="flex-col ">
          ...
          <div class=" p-1"></div>
          <button
            class="bg-blue-500 hover:bg-blue-700 text-white font-bold rounded px-8 pr-8 pt-6 pb-8 flex-none">upload
            profile
          </button>
        </div>
        ...
        <div class="flex-col ">
          ...
          <div class=" p-1"></div>
          <div class="bg-gray-900 w-128 shadow-md rounded px-8 pt-6 pb-8"> Description Description Description
            Description
          </div>
        </div>
